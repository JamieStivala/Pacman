...
public class GeneralMover extends Thread {
    ...
    /**
     * Will constantly move the game by 6 pixels depending on the rotation given unless collided with wall.
     ...
     * @param rotation The rotation the game currently is in
     */
    ...
    /**
     * This moves a ghost to a specified location when the game moves one block and also calculates the PathFinding in a separate thread
    ...
    /**
     * This is a method used to check if any coins have been taken.  If a coin has been take the whole game.map os updated and also
