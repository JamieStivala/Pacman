package game.items.moving.pacman;
...
public class Pacman extends Sprite {
    ...
    /**
     * @return The next rotation of the game when it is not overlapping
     */
    ...
    /**
     * Sets the next rotation of the game when it is not overlapping
     */
    ...
    /**
     * @return A boolean that represents if the game is collided with the wall
     */
    ...
    /**
     * Sets a boolean that represents if the game is collided with the wall
     */
