...
import game.map.Line;

import static game.items.moving.pacman.PacmanRotation.*;
...
public class OverlappingDetection extends Thread {
     ...
     * Whenever the game is overlapping the lines of the grid, it means that it can't rotate
     *
     * When the Pacman is not overlapping the grid, the game rotates to the next rotation
     */
    @Override
    public void run() {
