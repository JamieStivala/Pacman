...
/**
 * Checks if the game has collided with the wall.
...
public class WallCollisionDetection extends Thread {
    ...
    /**
     * @param frame The game frame that has almost all the objects of the Pacman
     */
    ...
    /**
     * The thread that consistently checks if the game is collided with the wall
     *
     * Since the game moves at 6 pixels I couldn't just use the area.isCollidedWith since this would check the whole block.  When checking
     * the whole block it sometimes found that the game is inside the block and when pressing the next button it would still be "collided" and the Pacman wouldn't move.
     *
