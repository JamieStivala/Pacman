...
public class CoinCollisionDetection extends Thread {
     ...
     * If it has, the coin is set to invisible, the score is updated and it triggers coinUpdatedSinceLastBuffer.  This is then used to render the map in GeneralMover.
    ...
    /**
     * Used in GeneralMover to let this thread know that the map has been updated since the coin has been taken
     */
