...
public class AStar {
    ...
    private static int DEFAULT_DIAGONAL_COST = 999999999;
    private int hvCost;
    ...
    private AStar(int rows, int cols, Node initialNode, Node finalNode, int hvCost, int diagonalCost) {
        ...
        this.openList = new PriorityQueue<>(Comparator.comparingInt(Node::getF).thenComparing(Node::getF));
        setNodes();
    ...
    public List<Node> findPath() {
        ...
        while (!isEmpty(openList)) {
            ...
            if (currentNode != null && isFinalNode(currentNode)) {
