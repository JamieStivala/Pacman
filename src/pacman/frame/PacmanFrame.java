...
import pacman.items.moving.ghosts.threads.GhostsCollisionDetection;
import pacman.items.moving.pacman.Pacman;
import pacman.items.moving.pacman.threads.ChompSoundThread;
import pacman.items.moving.pacman.threads.CoinCollisionDetection;
...
public class PacmanFrame extends JFrame {
     ...
     *
     * Here an instance of the pacman.map is created
    ...
    /**
     * This renders the pacman, the ghosts and also gets the pacman.map from that was pre-rendered.  It also adds the background
     */
    public void render() {
    ...
    /**
     * @return The generated pacman.map object
     */
